namespace Microsoft.WindowsAzure.Governance.DataLabs.IOService.TaskChannel.SubJobChannel
{
    ...
    public class SubJobChannelManager<TInput> : AbstractPartitionedBufferedTaskChannelManager<IOEventTaskContext<TInput>>, ISubJobChannelManager<TInput> where TInput : IInputMessage
    {
        public SubJobChannelManager() : base(IOTaskChannelType.SubJobChannel.FastEnumToString(), typeof(TInput).Name)
        {
        }
        ...
        protected override ValueTask BeforeProcessAsync(AbstractEventTaskContext<IOEventTaskContext<TInput>> eventTaskContext)
        {
            ...
            ioEventTaskContext.IOEventTaskFlags |= IOEventTaskFlag.AddedToSubJobChannel;
